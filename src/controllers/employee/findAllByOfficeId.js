...
exports.findAllByOfficeId = void 0;
...
const findAllByOfficeId = async (req, res) => {
    const { error: validationError, value: validatedData } = (0, requestHandler_1.validateRequest)(employeeSchema_1.findAllEmployeeByOfficeSchema, {
        ...req.params,
        officeId: Number(req.params.officeId),
        ...req.query
    });
    if (validationError)
        return (0, requestHandler_1.handleValidationError)(res, validationError);
    const { officeId, page: queryPage, size: querySize, search, pagination } = validatedData;
    try {
        ...
        logs_1.default.info(`Fetched employees by officeId ${officeId} successfully`);
...
exports.findAllByOfficeId = findAllByOfficeId;
