...
exports.findDetailOffice = void 0;
...
const findDetailOffice = async (req, res) => {
    ...
    try {
        ...
        logs_1.default.info('Office found successfully');
...
exports.findDetailOffice = findDetailOffice;
