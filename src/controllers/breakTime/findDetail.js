...
exports.findDetailBreakTime = void 0;
...
const findDetailBreakTime = async (req, res) => {
    const { error: validationError, value: validatedData } = (0, requestHandler_1.validateRequest)(breakTimeSchema_1.findDetailBreakTimeSchema, { ...req.params, breakTimeId: Number(req.params.breakTimeId) });
    if (validationError)
    ...
    try {
        ...
        logs_1.default.info('Break time detail retrieved successfully');
...
exports.findDetailBreakTime = findDetailBreakTime;
