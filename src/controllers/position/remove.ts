...
import { removePositionSchema } from '../../schemas/positionSchema'
import { IPositionRemoveRequest } from '../../interfaces/position/position.request'
